...
public class AppVersion {
	...
	@NotEmpty(message="版本号不能为空！",groups={Add.class,Update.class})
	private String versionNo;//版本号
	@NotEmpty(message="版本号不能为空！",groups={Add.class,Update.class})
	private String versionInfo;//版本描述
	private Integer publishStatus;//发布状态id
	private String downloadLink;//apk文件下载链接
	@NotNull(message="版本大小不能为空！",groups={Add.class,Update.class})
	@Min(value=0,message="版本大小不能为负数",groups={Add.class,Update.class})
