...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${ctx}/backendmanager/backend/app/list">
...
<script src="${ctx}/statics/localjs/applist.js"></script>
<script>
    $("#queryCategoryLevel1").change(function(){
        ...
        if(queryCategoryLevel1 != '' && queryCategoryLevel1 != null){
            $.ajax({
                type:"GET",//请求类型
                url:"${ctx}/backendmanager/backend/app/categorylevellist.json",//请求的url
    ...
    $(".checkApp").on("click",function(){
        ...
        if(status == "1" && vid != "" && vid != null){//待审核状态下才可以进行审核操作
            window.location.href="${ctx}/backendmanager/backend/app/check?aid="+ obj.attr("appinfoid") + "&vid="+ obj.attr("versionid");
