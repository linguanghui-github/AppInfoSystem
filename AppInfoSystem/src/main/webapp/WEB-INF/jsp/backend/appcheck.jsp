  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${ctx}/backendmanager/backend/app/checksave" method="post">
...
<script>
  $(function () {
     $("#back").click(function () {
         location.href="${ctx}/backendmanager/backend/app/list";
     });
  });
</script>